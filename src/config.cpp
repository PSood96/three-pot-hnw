...
const double BUY_COST_X = 60.0;
const double BUY_COST_ALL_X = 200.0;
const double BONUS_FREQ_2 = 1.0 / 5000.0;
const double BONUS_FREQ_3 = 1.0 / 500000.0;
const double BONUS_FREQ_1 = 1.0 / 180.0 - BONUS_FREQ_2 - BONUS_FREQ_3;
...
const FsProfile& fs1A() {
  static const FsProfile p = makeFs(
    ...
    {{
      {1.0/3.0, 0.06, 0.20, 0.042},
      {1.0/2.0, 0.06, 0.15, 0.02},
      {3.0/4.0, 0.10, -1.0, 0.01},
      {1.01, 0.002, -1.0, 0.0018}
    }},
    {{"0.5",1},{"1",2},{"1.5",10},{"2",10},{"2.5",10},{"5",10},{"10",5},
     {"MINI",5},{"MINOR",0.05},{"MAJOR",0.02}}
  );
  return p;
}
...
const FsProfile& fs1B() {
  static const FsProfile p = makeFs(
    ...
    {{
      {1.0/3.0, 0.05, 0.15, 0.032},
      {1.0/2.0, 0.05, 0.08, 0.02},
      {3.0/4.0, 0.06, -1.0, 0.01},
      {1.01, 0.002, -1.0, 0.0018}
    }},
    {{"0.5",50},{"1",50},{"1.5",10},{"2",10},{"2.5",10},{"5",5},{"10",1},
     {"MINI",0.08},{"MINOR",0.015},{"MAJOR",0.008}}
  );
  return p;
}
...
const FsProfile& fs1C() {
  static const FsProfile p = makeFs(
    ...
    {{
      {1.0/3.0, 0.05, 0.20, 0.04},
      {1.0/2.0, 0.05, 0.10, 0.02},
      {3.0/4.0, 0.08, -1.0, 0.01},
      {1.01, 0.002, -1.0, 0.001}
    }},
    {{"0.5",36},{"1",50},{"1.5",10},{"2",10},{"2.5",10},{"5",5},{"10",1},
